...
/**
 * @extends ServiceEntityRepository<Colisage>
 *
...
class ColisageRepository extends ServiceEntityRepository
{
    ...
    public function add(Colisage $entity, bool $flush = false): void
    {
    ...
    public function remove(Colisage $entity, bool $flush = false): void
    {
