 ...
 */
final class Version20220919090906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC276459A581 FOREIGN KEY (name_societe_id) REFERENCES societe (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP FOREIGN KEY FK_29A5EC276459A581');
